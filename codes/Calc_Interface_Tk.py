...
Treinamento de lógica e adição de conhecimento.
wiki.python.org.br/CalculadoraSimplesTk
...
class Calculadora:
    def __init__(self, topLevel):
        ...
        # Botão raiz
        raiz = Button(self.frame4, font=fonte1, text='Sqtr', command=self.sqrt)
        raiz.pack(side=LEFT)
        ...
        self.valor2 = Entry(self.frame3, text='Valor 2 :', font=fonte1)
